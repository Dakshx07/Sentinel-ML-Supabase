...
const ShaderAnimation = lazy(() => import('@/src/components/ui/ShaderAnimation'));
const RevealText = lazy(() => import('@/src/components/ui/RevealText'));
const ContainerScroll = lazy(() => import('@/src/components/ui/ContainerScroll'));
const WebGLShader = lazy(() => import('@/src/components/ui/WebGLShader'));
