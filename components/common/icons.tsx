...
export const ShieldIcon: React.FC<{ severity?: string, className?: string }> = ({ severity, className }) => {
  ...
  const severityClass = severity ? colorClasses[severity] : 'text-medium-dark-text dark:text-medium-text';
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={`${className} ${severityClass}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const SpinnerIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={`${className} animate-spin`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 3v3m0 12v3m-9-9h3m12 0h3m-2.828-7.172l-2.122 2.122m10.106 10.106l-2.122-2.122m-7.172-2.828l2.122-2.122m-10.106 10.106l2.122-2.122" />
  </svg>
);
...
export const PullRequestIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10 20v-6m0 0V4m0 0h5.5l-2.5 4.5" />
...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 19V6.5a3.5 3.5 0 013.5-3.5h0a3.5 3.5 0 013.5 3.5V19M8 19h8" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12a2 2 0 100-4 2 2 0 000 4zM12 12a2 2 0 110 4 2 2 0 010-4zM12 12a2 2 0 11-4 0 2 2 0 014 0zM12 12a2 2 0 104 0 2 2 0 00-4 0z" />
  </svg>
);
...
export const DatabaseZapIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4M4 7l8 4 8-4m-8 4v10m-4-7h8" />
  </svg>
);
...
export const CpuChipIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
    <path d="M5 11h14M5 17h14m-7-6v6m4-3h-8" />
  </svg>
);
...
export const VolumeUpIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M11 5.054A2 2 0 0113 7v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7a2 2 0 012-2h4z" />
  </svg>
);
...
// Newly added icons to fix runtime errors
