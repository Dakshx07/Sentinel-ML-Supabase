...
interface DeveloperCommandCenterProps {
    user: any; // Using any for now to avoid type issues, or import User type
...
const DeveloperCommandCenter: React.FC<DeveloperCommandCenterProps> = ({ user, setActiveView, repos }) => {
